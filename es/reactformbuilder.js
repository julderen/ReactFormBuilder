      ...
      default:
        {
          ...
          var component = React.createElement(DynamicComponents[type], _objectSpread({}, other, props && _.reduce(props, function (result, prop) {
...
var FormBuilder = connect(mapStateToProps)(DynamicFormContainer);
