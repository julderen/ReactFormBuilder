...
var _default = {
  composeValidationRules(validation, type, name, defaultValidation) {
    return (0, _extends2.default)({}, (0, _lodash.isFunction)(defaultValidation[type]) ? defaultValidation[type](name) : defaultValidation && defaultValidation[type], validation);
  },
